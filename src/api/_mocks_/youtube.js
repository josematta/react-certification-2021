...
export const youtube = (function () {
    ...
    return {
      search: jest.fn(() => { return Promise.resolve(myObj) })
      ,
      related: jest.fn(() => { return Promise.resolve(myObj) })
    };
  })();